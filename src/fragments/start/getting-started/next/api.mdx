...
<iframe src="https://stackblitz.com/edit/react-code-sample?embed=1&file=index.js"></iframe>

<iframe src="https://stackblitz.com/github/timngyn/sample-app?embed=1&file=amplify/backend/api/nextamplified/schema.graphql&hideExplorer=1&hideNavigation=1&view=editor"></iframe>

<StackBlitzEmbed vmId="vm1" github={"timngyn/sample-app"} openFile={"amplify/backend/api/nextamplified/schema.graphql"}></StackBlitzEmbed>
...
<StackBlitzEmbed vmId="vm2"  github={"timngyn/sample-app"} openFile={"pages/index.tsx:L3-L10"}></StackBlitzEmbed>
